...
import sys  
import os  
targetDir = rE:PythonWorkPlaceload  #文件保存路径
def destFile(path):  
...
if __name__ == __main__:  #程序运行入口
    ...
    webheaders = {'User-Agent: Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/56.0.2924.87 Safari/537.36'} 
